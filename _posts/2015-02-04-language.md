...
the first uses `LEFT, STRICT` whereas the second uses `UP`

![foo](../images/full_strict.png)

[above: to look `STRICT`ly in the same row, you need to look `LEFT`

![foo](../images/full_loose.png)

[above: whereas non-`STRICT` looks use `LEFT`.
